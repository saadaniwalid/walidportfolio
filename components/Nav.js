...
const Nav = () => {
  ...
  return (
    <nav
      className="flex flex-col fixed h-max items-center xl:justify-center gap-y-4 w-full xl:w-16
   xl:max-w-md mt-0 z-50 bottom-0   xl:right-[2%] xl:h-screen"
    >
      <div
        className="flex w-full xl:flex-col items-center justify-between
     xl:justify-center gap-y-10 px-4 xl:px-0 md:px-40 h-[80px] xl:h-max py-8 bg-white/10 backdrop-blur-sm text-3xl
